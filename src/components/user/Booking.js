...
// REMOVE HARDCODED KEY WITH USER_UID: FYfSqBU5JgSP2GUilJmz
        ...
        <View style={bookingStyles.container}>
            ...
            <View style={bookingStyles.bookRideButtonView}>
                <TouchableOpacity style={bookingStyles.bookRideNowButton} onPress={() => {
                    ...
                    const pickup_longitude = route.params.ride_pickup_location.longitude;
                    ...
                    (async () => {
                        try {
                            ...
                            await setDoc(doc(db, "Rides", currentRide), {
                                ...
                                riders: [ // USED for Testing: should pass empty array only
                                    {
                                        ...
                                        rider_profilepic: "https://firebasestorage.googleapis.com/v0/b/caravan-123.appspot.com/o/UserImages%2F1673168812197?alt=media&token=49db0a0e-e273-4915-9faf-44945fe1b864" 
                                    },
                                    {
                                        ...
                                        rider_profilepic: "https://firebasestorage.googleapis.com/v0/b/caravan-123.appspot.com/o/UserImages%2F1673167281432?alt=media&token=a073f1e7-be61-4f57-bb1f-dbeafd9eb5f9"  
                                    },
                                ]
                            });
