...
import {
  ...
  GestureHandlerRootView
    ...
    // This Component will be rendered if driver is very close to the rider's location
export  function CloseToRider({route,navigation}){
    ...
    const waitForRider = () =>{
        console.log('Insdie watiForRider');
        
        navigation.navigate('DriverScreen',{
            screen:'WaitingForRider',
            params:route.params
        })
    ...
    <GestureHandlerRootView style={styles.container}>
        <View style={styles.viewCont}>
            <View style={styles.cont}>
                <Image source={{uri:customerPic}}  style={{width: 70, height: 70,borderRadius: 70/ 2}} />
                <Text style={styles.bldTxt}>{ customerName}</Text>
            </View>
            <TouchableOpacity style={styles.gbtn} onPress={() => waitForRider()}>
                <Text style={styles.gbtnTxt}>Arrived at Pickup Point</Text>
            </TouchableOpacity>
            ...
            <View style={styles.Rdetails}>
                ...
                <View>
                    <View style={[styles.rInfo,{backgroundColor:"#F5F5F5"}]}>
